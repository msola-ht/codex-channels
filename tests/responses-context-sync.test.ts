...
async function fixture() {
  ...
  const definition={id:"vendor/flash",name:"Mapped",contextWindow:1048576,reasoningEfforts:[],defaultReasoningEffort:null,supportsImages:false,template:{source:"deepseek" as const,model:"deepseek-v4-flash",followContext:true}};
