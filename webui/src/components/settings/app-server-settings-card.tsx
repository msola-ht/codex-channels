  ...
  return <>
    ...
    <Card>
      ...
      <CardContent className="grid gap-x-8 gap-y-3 text-sm md:grid-cols-2">
        ...
        <ManagedSelect label="空闲总结" value={String(settings.defaults.autoRecapEnabled ?? false)} options={[["false", "关闭"], ["true", "开启"]]} disabled={management.saving || management.pendingSetting !== null} onChange={(value) => void management.previewSetting({ kind: "auto-recap", enabled: value === "true" }, "空闲总结")} />
