...
export interface TurnOutputTiming {
  /** 本轮有效模型请求的端到端有效速率（合计输出除以合计请求耗时），由已持久化请求派生。 */
  tokensPerSecond?: number;
  /** 本轮有效模型请求的生成速率（合计输出除以合计解码窗口），由已持久化请求派生。 */
