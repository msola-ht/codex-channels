...
async function promptPreferences(prompts, settings) {
  ...
  return { reasoningSummary, planModeReasoningEffort, verbosity, checkForUpdateOnStartup, historyPersistence };
}
