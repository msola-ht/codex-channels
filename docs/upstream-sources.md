...
| 用途 | 本地目录 | 官方仓库 | 当前基线 |
| --- | --- | --- | --- |
| Codex CLI、Core 与 App Server 协议行为 | `upstream/openai-codex` | `openai/codex` | `rust-v0.146.1`，提交 `79b4f03d35962b005b007a015113b38930711665` |
...
```text
git clone --depth 1 --branch rust-v0.146.1 https://github.com/openai/codex.git upstream/openai-codex
