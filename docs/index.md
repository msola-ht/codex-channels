...
| Windows App Server Proxy | [`cli/src/main.rs`](https://github.com/openai/codex/blob/rust-v0.154.0/codex-rs/cli/src/main.rs) | `app-server proxy --sock` 的 CLI 入口；本项目 Windows 本机 Transport 与 Desktop 桥继续复用 |
