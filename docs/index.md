...
官方行为见锁定版本的
[`role.rs`](https://github.com/openai/codex/blob/rust-v0.155.1/codex-rs/core/src/agent/role.rs) 与
[`role_tests.rs`](https://github.com/openai/codex/blob/rust-v0.155.1/codex-rs/core/src/agent/role_tests.rs)。
