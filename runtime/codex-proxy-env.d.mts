...
export function readCodexProxyMigrationSnapshot(environment?: NodeJS.ProcessEnv): CodexProxySnapshot;
...
export function writeCodexProxySnapshot(snapshot: CodexProxySnapshot, content: string | null): void;
